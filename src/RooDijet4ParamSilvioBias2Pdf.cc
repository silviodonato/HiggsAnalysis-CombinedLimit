...
#include "../interface/RooDijet4ParamSilvioBias2Pdf.h"
...
ClassImp(RooDijet4ParamSilvioBias2Pdf)
//---------------------------------------------------------------------------
RooDijet4ParamSilvioBias2Pdf::RooDijet4ParamSilvioBias2Pdf(const char *name, const char *title,
				   RooAbsReal& _th1x,  
...
//---------------------------------------------------------------------------
RooDijet4ParamSilvioBias2Pdf::RooDijet4ParamSilvioBias2Pdf(const RooDijet4ParamSilvioBias2Pdf& other, const char* name) :
...
//---------------------------------------------------------------------------
void RooDijet4ParamSilvioBias2Pdf::setTH1Binning(TH1* _Hnominal){
...
//---------------------------------------------------------------------------
void RooDijet4ParamSilvioBias2Pdf::setRelTol(double _relTol){
  relTol = _relTol;
}
//---------------------------------------------------------------------------
void RooDijet4ParamSilvioBias2Pdf::setAbsTol(double _absTol){
  absTol = _absTol;
}
//---------------------------------------------------------------------------
Double_t RooDijet4ParamSilvioBias2Pdf::evaluate() const
{
  ...
  Dijet4ParamSilvioBias2Function func;
  double params[7];
...
// //---------------------------------------------------------------------------
Int_t RooDijet4ParamSilvioBias2Pdf::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* rangeName) const{
  if (matchArgs(allVars, analVars, th1x)) return 1;
  return 0;
}

// //---------------------------------------------------------------------------
Double_t RooDijet4ParamSilvioBias2Pdf::analyticalIntegral(Int_t code, const char* rangeName) const{
  ...
  ig.SetFunction(func,false);
   ...
   if (code==1 && iBinMin<=0 && iBinMax>=xBins){
     ...
     cout << "WARNING IN RooDijet4ParamSilvioBias2Pdf: integration code is not correct" << endl;
