//---------------------------------------------------------------------------
#ifndef HiggsAnalysis_CombinedLimit_RooDijet5ParamBinPdf_h
#define HiggsAnalysis_CombinedLimit_RooDijet5ParamBinPdf_h
//---------------------------------------------------------------------------
#include "RooAbsPdf.h"
...
//---------------------------------------------------------------------------
class RooDijet5ParamBinPdf : public RooAbsPdf
{
public:
   RooDijet5ParamBinPdf() {} ;
   RooDijet5ParamBinPdf(const char *name, const char *title,
   ...
   RooDijet5ParamBinPdf(const char *name, const char *title,
		  ...
		  RooAbsReal& _p2, RooAbsReal& _p3, RooAbsReal& _p4,
		  RooAbsReal& _sqrts);
   RooDijet5ParamBinPdf(const RooDijet5ParamBinPdf& other,
      const char* name = 0);
   void setTH1Binning(TH1* _Hnominal);
   void setAbsTol(double _absTol);
   void setRelTol(double _relTol);
   virtual TObject* clone(const char* newname) const { return new RooDijet5ParamBinPdf(*this,newname); }
   inline virtual ~RooDijet5ParamBinPdf() { }
...
private:
   ClassDef(RooDijet5ParamBinPdf,1) // RazorDijet5ParamBinPdf function
...
class Dijet5ParamFunction: public ROOT::Math::IParametricFunctionOneDim
{
private:
   const double *pars;
...
public:
   ...
   {
      return new Dijet5ParamFunction();
   }
