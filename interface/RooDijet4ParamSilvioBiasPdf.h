//---------------------------------------------------------------------------
#ifndef HiggsAnalysis_CombinedLimit_RooDijet4ParamSilvioBiasPdf_h
#define HiggsAnalysis_CombinedLimit_RooDijet4ParamSilvioBiasPdf_h
//---------------------------------------------------------------------------
#include "RooAbsPdf.h"
...
//---------------------------------------------------------------------------
class RooDijet4ParamSilvioBiasPdf : public RooAbsPdf
{
public:
   RooDijet4ParamSilvioBiasPdf() {} ;
   RooDijet4ParamSilvioBiasPdf(const char *name, const char *title,
   ...
   RooDijet4ParamSilvioBiasPdf(const char *name, const char *title,
		  ...
		  RooAbsReal& _p2, RooAbsReal& _p3, 
		  RooAbsReal& _sqrts);
   RooDijet4ParamSilvioBiasPdf(const RooDijet4ParamSilvioBiasPdf& other,
      const char* name = 0);
   void setTH1Binning(TH1* _Hnominal);
   void setAbsTol(double _absTol);
   void setRelTol(double _relTol);
   virtual TObject* clone(const char* newname) const { return new RooDijet4ParamSilvioBiasPdf(*this,newname); }
   inline virtual ~RooDijet4ParamSilvioBiasPdf() { }
...
private:
   ClassDef(RooDijet4ParamSilvioBiasPdf,1) // RazorDijet4ParamPolyExtBinPdf function
...
class Dijet4ParamSilvioBiasFunction: public ROOT::Math::IParametricFunctionOneDim
{
private:
   const double *pars;
...
//OK     double pdf = exp(-pars[2]*(x/pars[0]))/pow(x/pars[0],pars[1])  / (exp(1/TMath::Max(x-pars[3],1e-9))-1);
   ...
   {
      return new Dijet4ParamSilvioBiasFunction();
   }
